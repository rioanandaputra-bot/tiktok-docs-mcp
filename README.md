...
```bash
git clone https://github.com/rioanandaputra-bot/tiktok-docs ~/.claude/skills/tiktok-docs
```
...
- Output script adalah struktur mentah per-file; jalankan langkah konsolidasi (merge per kategori) sebelum mengganti isi `docs/`, sesuai catatan di `SKILL.md` Bagian 7.
